...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `https://i.ibb.co/5hKkLxqY/tronk4.jpg`, text: 'Bridge' },
      { image: `https://static.wikia.nocookie.net/dragonball/images/e/e7/TrunksFutureNV020.jpg.png/revision/latest/scale-to-width-down/450?cb=20120630172646&path-prefix=es`, text: 'Desk Setup' },
